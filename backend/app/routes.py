...
from .controllers.admin import admin_login, get_all_products, get_product_detail, update_product, create_product, delete_product, get_all_transactions
...
admin_bp.route('/transactions/<int:transaction_id>', methods=['GET'])(get_all_transactions)